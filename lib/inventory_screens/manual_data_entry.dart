...
class _ManualEntryScreenState extends State<ManualEntryScreen> {
  ...
  Widget _entryField(String title, TextEditingController controller, int max,
      bool isNumField) {
      ...
      validator: Validators.compose([
        ...
        if (isNumField)
          Validators.patternString(
              r'^[0-9]*$', "Only numbers within this field"),
      ]),
      maxLines: max,
    );
  }
    ...
    return ElevatedButton(
      onPressed: () async {
        ...
        if (formKey.currentState!.validate()) {
          ...
          DocumentReference docRef = await addInventoryItems(
              itemName, noOfUnits, priceOfUnit, itemDesc);
  ...
  Future<DocumentReference> addInventoryItems(
      String itemName, int noOfUnits, int priceOfUnit, String itemDesc) async {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: _entryField(
                        'Input item name', _inputController, 1, false),
                  ),
                  Align(
                      alignment: Alignment.topLeft,
                      child: Padding(
                  ...
                  Padding(
                    ...
                    child: _entryField('Input number of units added',
                        _noOfUnitsController, 1, true),
                  ),
                  Align(
                      alignment: Alignment.topLeft,
                      child: Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 10.0, vertical: 5),
                    child: _entryField(
                        'Input unit price', _unitPriceController, 1, true),
                  ),
                  Align(
                      alignment: Alignment.topLeft,
                      child: Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 10.0, vertical: 5),
                    child: _entryField('Input information about the product',
                        _detailsputController, 5, false),
                  ),
                  SizedBox(
                    height: 10,
                  ),
